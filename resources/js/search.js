...
spinner_html = `
<div class="spinner-border text-danger" role="status" id="search-spinner">
...
/* Function to append zeros to be used to make the book:section numbers fixed length in the results. */
...
function rmy_search(result_selector, query_selector)
{
    ...
    xhr.onreadystatechange = () => {
        ...
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            {
                book_section = key.split(":");
                result_url = "/" + book_section[0] + "/" + book_section[1] + ".html";
                result_content += `<b>${number_to_string_fixed_length(book_section[0], 2)}:${number_to_string_fixed_length(book_section[1], 3)}</b>&nbsp;`;
    ...
    var data = JSON.stringify({"text": "RMY", "query": query});
