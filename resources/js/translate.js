...
var translate_element = `<div class="card shadow-lg w-25 translation-card" id="translation-card">
            <div class="card-header">
                ...
                <button class="btn btn-danger btn-sm rounded shadow" style="float:right;" onClick="$('#translation-card').fadeOut()"><span class="fa fa-x"></span></button>
            </div>
            <div class="card-body">
...
var translate_button = `<button class="btn btn-danger btn-translator fs-6" onclick="translate_selection()"><span class="fa fa-language"></span>&nbsp;सं &#10132; EN</b></button>`;
